...
import { 
  ...
  FileText, Printer, X, TrendingUp, TrendingDown, Minus, BarChart2
} from 'lucide-react';
                     ...
                     return (
                         ...
                         >
                             ...
                             <div className="p-4 flex-1 flex flex-col relative">
                                 ...
                                 {/* Mini Trend Chart */}
                                 <div className="h-10 w-full opacity-60 group-hover:opacity-100 transition-opacity mt-auto mb-3">
                                     {hasData ? (
                                         <ResponsiveContainer width="100%" height="100%">
