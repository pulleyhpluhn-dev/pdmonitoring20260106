...
import { LayoutDashboard, Activity, AlertTriangle, Database, Settings, LogOut, Sun, Moon, ChevronLeft, ChevronRight, Menu, LayoutGrid, PlugZap, FileOutput, Globe, Check, Sparkles } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const menuItems = [
    ...
    { key: 'export', icon: FileOutput, label: '数据导出' },
